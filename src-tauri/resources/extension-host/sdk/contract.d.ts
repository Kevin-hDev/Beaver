...
export declare const HOST_DIAGNOSTIC_CODES: readonly ["module_not_found","syntax_error","activation_failed","registration_failed","import_failed"];
export declare const RUNTIME_DIAGNOSTIC_CODES: readonly ["entry_unavailable","load_failed","host_missing_response","advanced_required"];
