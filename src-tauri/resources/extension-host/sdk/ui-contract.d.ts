...
export declare const UI_THEME_TOKENS: readonly ["--app-frame","--shell","--surface","--surface-hover","--surface-overlay","--surface-raised","--card-on-glass","--field-bg","--select-bg","--select-text","--edge","--edge-strong","--border-subtle","--ink","--ink-muted","--ink-faint","--ink-primary","--text-primary","--text-secondary","--text-tertiary","--pulse","--pulse-hover","--pulse-muted","--danger","--signal-alert","--signal-error","--signal-error-bg","--signal-info","--signal-info-bg","--signal-ok","--signal-ok-bg","--signal-warning","--signal-warning-bg","--chat-composer-bg","--chat-composer-border","--toast-bg","--toast-error-text","--toast-ok-text","--diff-add-bg","--diff-add-gutter","--diff-del-bg","--diff-del-gutter","--diff-new","--diff-old"];
