...
fn checked_in_typescript_matches_the_rust_diagnostics_contract() {
    let checked_in =
        include_str!("../../../../../src/types/agent-diagnostics.ts").replace("\r\n", "\n");
    ...
    let tool_result_checked_in =
        include_str!("../../../../../src/types/agent-tool-result-contract.ts")
            .replace("\r\n", "\n");
...
fn legacy_diagnostic_run_without_attempt_identity_remains_readable() {
    let run: super::types_diagnostics::AgentDiagnosticRun =
