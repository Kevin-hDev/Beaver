...
fn parent_stream_token_reaches_delegate_registration_on_every_control_path() {
    let batch = include_str!("../tools/tool_executor_delegate_batch.rs");
    let dispatcher = include_str!("../tools/tool_dispatcher.rs");
    let fallback = include_str!("../tools/tool_dispatcher_fallback.rs");
    let message = include_str!("../tools/tool_subagent_message.rs");
    let delegate = include_str!("../tools/tool_delegate.rs");
