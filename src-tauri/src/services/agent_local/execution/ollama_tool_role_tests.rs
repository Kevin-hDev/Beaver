...
fn placement() -> crate::services::llm::route_profile::ToolResultPlacement {
    crate::services::llm::route_profile::payload_policy("ollama", "fixture")
        .unwrap()
        .message
        .tool_results
}
...
fn wraps_tool_message_as_user_with_tool_response() {
    ...
    let out = wrap_tool_results(&msgs, placement());
    assert_eq!(out.len(), 1);
...
fn does_not_mutate_input() {
    ...
    let _ = wrap_tool_results(&msgs, placement());
