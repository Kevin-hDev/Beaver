...
pub fn apply(
    ...
    match policy {
        ParameterPolicy::Zai => super::stream_reasoning_zai::apply(payload, model, reasoning_mode),
...
pub(super) fn apply_thinking(payload: &mut Value, reasoning_mode: Option<&str>) {
