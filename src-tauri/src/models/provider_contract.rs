...
pub use crate::services::provider_connections::qwen::QwenConnectionInput;
#[cfg(test)]
use crate::services::provider_connections::qwen::{QwenEndpointMode, QwenRegion};
...
pub(crate) fn typescript_bindings() -> String {
    ...
    format!(
        ...
        ProviderConnectionKind::decl(&config),
        QwenRegion::decl(&config),
        QwenEndpointMode::decl(&config),
        QwenConnectionInput::decl(&config),
