...
pub async fn commit_and_checkout_git_branch(
    ...
    .await
    .map_err(|e| {
        ::log::error!("[git] commit_and_checkout: {e}");
        GitActionError::InternalError
    })?
}
