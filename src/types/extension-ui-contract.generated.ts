...
export const UI_THEME_TOKENS = ["--void","--app-frame","--shell-opaque","--surface","--surface-hover","--edge","--edge-strong","--surface-glass","--surface-overlay","--surface-raised","--card-on-glass","--field-bg","--btn-secondary-bg","--ink","--ink-muted","--ink-faint","--ink-on-pulse","--ink-on-danger","--pulse","--pulse-muted","--switch-track-off","--switch-track-border","--switch-track-hover","--switch-track-on","--switch-knob","--signal-error","--signal-ok","--signal-warning","--signal-alert","--signal-info","--signal-error-bg","--signal-ok-bg","--signal-warning-bg","--signal-alert-bg","--signal-info-bg","--tooltip-bg","--tooltip-border","--tooltip-text","--chat-composer-bg","--chat-composer-border","--toast-bg","--toast-error-text","--toast-ok-text","--diff-add-bg","--diff-del-bg","--diff-new","--diff-old"] as const;
