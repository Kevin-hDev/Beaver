...
/* Crayon posé sur un trait : le dessin dit qu'on récrit une étiquette, là où
   un crayon seul dit seulement qu'on modifie quelque chose. */
export function RenameIcon({ size = "var(--session-action-icon-size)", className }: InlineIconProps) {
  return (
